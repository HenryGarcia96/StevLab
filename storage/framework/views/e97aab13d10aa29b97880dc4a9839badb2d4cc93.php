...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crear_perfiles')): ?>
                    ...
                    <div class="table">
                        <div class="table-responsive">
                            <table id="dataTablePerfiles" class="table text-center" width="100%">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $perfiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr >
                                            <td>
                                                <span>
                                                    <?php echo e($item->clave); ?>
                                            ...
                                            <td >
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar_perfiles')): ?> 
                                                    <a onclick="editarPerfil(this)" class="btn btn-icon btn-xs btn-success" href="#"><i class="mdi mdi-pencil"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar_estudios_perfil')): ?>
                                                    <a onclick="asignarEstudios(<?php echo e($item->id); ?>)" class="btn btn-icon btn-xs btn-secondary" href="#"><i class="mdi mdi-chemical-weapon"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar_perfiles')): ?>
                                                    <a href="<?php echo e(route('stevlab.catalogo.delete-profile', $item->id)); ?>" class="btn btn-icon btn-xs btn-danger"><i class="mdi mdi-delete"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<script src="<?php echo e(asset('public/stevlab/catalogo/perfiles/select2.js')); ?>?v=<?php echo rand();?>"></script>
<script src="<?php echo e(asset('public/stevlab/catalogo/perfiles/form-validation.js')); ?>?v=<?php echo rand();?>"></script>
<script src="<?php echo e(asset('public/stevlab/catalogo/perfiles/functions.js')); ?>?v=<?php echo rand();?>"></script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laboratorios\resources\views/catalogo/perfiles/index.blade.php ENDPATH**/ ?>